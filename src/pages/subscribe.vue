      ...
      <div class="weui-cells">
        <div class="weui-cell">
          <div class="weui-cell__hd">
            <img :src="WEIXIN_IMG_URL + productDetail.img + '_200x200.jpg'" width="90"/>
          </div>
...
<script>
  ...
  import { WEIXIN_LOGIN_URL, SUBSCRIBE, WEIXIN_IMG_URL } from '@/assets/js/const';
        ...
        LXAjax('get', 'api/user/core/myUserInfo')
          .done(res => {
            ...
            if(this.subscribe.tel === '' || this.subscribe.tel === null || this.subscribe.tel === undefined){
              this.$router.push('/login?openId='+this.openId+'&redirect=' + "/subscribe?productId=" +  this.productId );
            }
          })
          .fail(res => {
            if(res.flag == -1){
